#calculator
#output
set_property IOSTANDARD LVCMOS33 [get_ports {operator[3]}]
set_property PACKAGE_PIN L1 [get_ports {operator[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {operator[2]}]
set_property PACKAGE_PIN P1 [get_ports {operator[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {operator[1]}]
set_property PACKAGE_PIN N3 [get_ports {operator[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {operator[0]}]
set_property PACKAGE_PIN P3 [get_ports {operator[0]}]
