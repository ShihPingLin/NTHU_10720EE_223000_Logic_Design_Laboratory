...
set_property PACKAGE_PIN V14 [get_ports {LED_A[3]}]
set_property PACKAGE_PIN U14 [get_ports {LED_A[2]}]
set_property PACKAGE_PIN U15 [get_ports {LED_A[1]}]
set_property PACKAGE_PIN W18 [get_ports {LED_A[0]}]
set_property PACKAGE_PIN V19 [get_ports {LED_B[3]}]
set_property PACKAGE_PIN U19 [get_ports {LED_B[2]}]
set_property PACKAGE_PIN E19 [get_ports {LED_B[1]}]
set_property PACKAGE_PIN U16 [get_ports {LED_B[0]}]
