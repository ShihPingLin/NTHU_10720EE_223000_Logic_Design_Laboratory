...
set_property PACKAGE_PIN T17 [get_ports mode]
set_property IOSTANDARD LVCMOS33 [get_ports point]
set_property PACKAGE_PIN V7 [get_ports point]
set_property IOSTANDARD LVCMOS33 [get_ports mode_ap]
set_property PACKAGE_PIN V17 [get_ports mode_ap]
set_property IOSTANDARD LVCMOS33 [get_ports mode_clk]
set_property PACKAGE_PIN R2 [get_ports mode_clk]
